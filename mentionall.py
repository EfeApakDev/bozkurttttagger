...
async def start(event):
  await event.reply("**🇹🇷BOZKURT TaggerBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket atabilen gelişmiş tagger botudur \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', f"https://t.me/{bot_username}?startgroup=a")],
                      [Button.url('Support🛠', f"https://t.me/{support}")],
                      [Button.url('Sahibim', f"https://t.me/{owner}")],
		      [Button.url('ADMİN👨🏻‍💻', 'https://t.me/bozkurt20')],
                    ),
                    link_preview=False
                   )
...
async def help(event):
  helptext = "**🇹🇷 BOZKURT TaggerBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag atar**\n\n**/start - botu başlatır**"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', f"https://t.me/{bot_username}?startgroup=a")],
                      [Button.url('Support🛠', f"https://t.me/{support}")],
                      [Button.url('Sahibim🔖', f"https://t.me/{owner}")],
		      [Button.url('DESTEK🧑‍🔧', 'https://t.me/bozkurt20)],
                    ),
                    link_preview=False
                   )
...
async def mentionall(event):
  ...
  if event.pattern_match.group(1):
    ...
    if msg == None:
        return await event.respond("**Geçmiş mesajlar için etiket edemiyorum**")
  ...
  if mode == "text_on_cmd":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in tekli_calisan:
        await event.respond("**Işlem Başarıyla Durduruldu\n\n**Buda sizin reklamınız ola bilir @bozkurt20**❌****")
        return
      if usrnum == 1:
